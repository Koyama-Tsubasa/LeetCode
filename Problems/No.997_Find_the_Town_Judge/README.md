...
<div class="_1l1MA" data-track-load="qd_description_content"><p>In a town, there are <code>n</code> people labeled from <code>1</code> to <code>n</code>. There is a rumor that one of these people is secretly the town judge.</p>
