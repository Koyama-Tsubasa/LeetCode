...
<div><div class="elfjS" data-track-load="description_content"><p>You are given a <span data-keyword="binary-array" class=" cursor-pointer relative text-dark-blue-s text-sm"><button type="button" aria-haspopup="dialog" aria-expanded="false" aria-controls="radix-:rp:" data-state="closed" class="">binary array</button></span> <code>nums</code>.</p>
