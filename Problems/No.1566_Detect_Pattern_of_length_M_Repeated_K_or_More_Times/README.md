...
<div class="_1l1MA" data-track-load="qd_description_content"><p>Given an array of positive integers <code>arr</code>, find a pattern of length <code>m</code> that is repeated <code>k</code> or more times.</p>
