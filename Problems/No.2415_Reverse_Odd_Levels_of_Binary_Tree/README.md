...
<div class="_1l1MA" data-track-load="qd_description_content"><p>Given the <code>root</code> of a <strong>perfect</strong> binary tree, reverse the node values at each <strong>odd</strong> level of the tree.</p>
