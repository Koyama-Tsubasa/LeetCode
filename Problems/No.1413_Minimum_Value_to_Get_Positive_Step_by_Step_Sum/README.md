...
<div class="_1l1MA" data-track-load="qd_description_content"><p>Given an array of integers&nbsp;<code>nums</code>, you start with an initial <strong>positive</strong> value <em>startValue</em><em>.</em></p>
