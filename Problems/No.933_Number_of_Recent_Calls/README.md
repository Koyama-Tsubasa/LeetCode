...
<div class="_1l1MA" data-track-load="qd_description_content"><p>You have a <code>RecentCounter</code> class which counts the number of recent requests within a certain time frame.</p>
